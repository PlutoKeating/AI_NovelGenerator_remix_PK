...
import traceback
import glob
from backend.utils import read_file, save_string_to_txt, clear_file_content, get_word_count
...
def generate_chapter_draft_ui(self):
    ...
    def task():
        ...
        try:
            ...
            from backend.novel_generator.chapter import generate_chapter_draft
